...
DrawPin's [README](README.md) is written for people visiting the project, not
running it. This file has what you need to build, test, and work on the code.
...
- One branch → one pull request. Branches: `type/short-name`, with an issue
...
- Full working agreement — architecture decisions, domain rules, coding
  conventions — is in [`CLAUDE.md`](CLAUDE.md).
